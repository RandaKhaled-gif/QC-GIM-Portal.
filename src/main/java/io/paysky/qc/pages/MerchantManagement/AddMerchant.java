...
public class AddMerchant {
    ...
    By SelectNotificationMethod = By.xpath("//option[. = 'Email']");
    By EmptyArea = By.xpath("//div[@id='step-4']/div[3]/div/div/h5");
    ...
    public void selectEmail(){ driver.findElement(SelectNotificationMethod).click(); }
